...
#include "BuildEscape/OpenDoor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	BUILDESCAPE_API UClass* Z_Construct_UClass_UOpenDoor_NoRegister();
	BUILDESCAPE_API UClass* Z_Construct_UClass_UOpenDoor();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOpenDoor_Statics::NewProp_DoorOpenSpeed = { "DoorOpenSpeed", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOpenDoor, DoorOpenSpeed), METADATA_PARAMS(Z_Construct_UClass_UOpenDoor_Statics::NewProp_DoorOpenSpeed_MetaData, ARRAY_COUNT(Z_Construct_UClass_UOpenDoor_Statics::NewProp_DoorOpenSpeed_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UOpenDoor, 3731150634);
	template<> BUILDESCAPE_API UClass* StaticClass<UOpenDoor>()
	{
		return UOpenDoor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UOpenDoor(Z_Construct_UClass_UOpenDoor, &UOpenDoor::StaticClass, TEXT("/Script/BuildEscape"), TEXT("UOpenDoor"), false, nullptr, nullptr, nullptr);
